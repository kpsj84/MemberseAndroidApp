...
public class Base {
	...
	public static void cloudCapabilities(String appName) throws IOException, InterruptedException{		
		...
		cap.setCapability("app", "MemberseAndroidApp");									//This is the use of custom_id. here shareable_id to use if other member to test this app, Uploaded QA Build-5.1.3(522)
