...
public class aCommunityGuidelinesTest extends Base {
	
	@Test
	public void aCommunityGuidelinesTestCase() throws InterruptedException {
		...
		Assert.assertEquals(verifyText, "Community Guidelines");
	}
