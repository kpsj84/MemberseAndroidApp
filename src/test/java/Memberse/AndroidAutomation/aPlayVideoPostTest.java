...
public class aPlayVideoPostTest extends Base {
	
	@Test
	public void aPlayVideoPostTestCase() throws InterruptedException {
		Utilities u = new Utilities(driver);
		u.DirectToLoginOptionPage();
		
		String userNumber = "cvp";
		...
		Assert.assertEquals(postText, "Auto Test - View Video Post");
	}
