...
public class aViewTextPostTest extends Base {
	
	@Test
	public void aViewTextPostTestCase() throws InterruptedException {
		Utilities u = new Utilities(driver);
		u.DirectToLoginOptionPage();
		
		String userNumber = "ctp";
		...
		Assert.assertEquals(postText, "Auto Test View Text Post");
	}
