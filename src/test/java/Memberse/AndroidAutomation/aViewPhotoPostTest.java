...
public class aViewPhotoPostTest extends Base {
	
	@Test
	public void aViewPhotoPostTestCase() throws InterruptedException {
		Utilities u = new Utilities(driver);
		u.DirectToLoginOptionPage();
		
		String userNumber = "cpp";
		...
		Assert.assertEquals(postText, "Auto Test - View Photo Post");
	}
